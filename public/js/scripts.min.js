...
! function(e) {
    ...
    e(function() {
        ...
        e(".post-type-archive-project").find(".numeric-navigation").on("click", ".page-numbers.next", function(t) {
                ...
                var a = "";
                e(this).children("a").hasClass("dropdown-toggle") && (a = e(this).children(".dropdown-toggle").html()), e(this).children("ul").prepend('<li class="menu-parent-items">' + a + "</li>"), e(this).children("ul").prepend('<li class="menu-back">' + kdmexpress.kdmexpress_back + "</li>")
