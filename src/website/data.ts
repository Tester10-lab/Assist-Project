import { NavLink, ServiceItem, TestimonialItem, GoogleReviewItem, GalleryProject, TeamMember } from './types';
...
export const GOOGLE_REVIEWS: GoogleReviewItem[] = [
  {
    ...
    timeAgo: '2 weeks ago',
    project: 'Full Colorbond Roof Replacement',
    comment: 'Boxy and Peter are true professionals. After severe storm winds damaged our tiled roof, Peter arrived with a drone for inspection and provided an honest, fixed-price quote. Boxy and the crew worked tirelessly, kept the property spotless with their magnetic nail sweepers, and the new Colorbond roof looks spectacular. Hands down the best roofing contractors in Melbourne!',
    verified: true,
  },
  {
    id: 'gr-2',
    ...
    rating: 5,
    timeAgo: '3 weeks ago',
    project: 'Heritage Tile Restoration & Ridge Pointing',
    comment: 'Outstanding roofing service from start to finish. We had persistent leaks near the valleys and cracked mortar on our ridge capping. Assist identified the root cause immediately, re-bedded and re-pointed with flexible SupaPoint, and gave us complete photo evidence before and after. 5 stars all the way!',
    verified: true,
  },
  {
    id: 'gr-3',
    ...
    rating: 5,
    timeAgo: '1 month ago',
    project: 'Roof Leak Detection & Valley Repair',
    comment: 'Called Assist for an urgent roof leak during heavy rain. They had a technician on our roof within 3 hours. Replaced damaged valley irons and sealed the flashings. Honest, no pushy upsells, and completely watertight ever since. Fantastic customer care.',
    verified: true,
  },
  {
    id: 'gr-4',
    ...
    rating: 5,
    timeAgo: '1 month ago',
    project: 'Colorbond Gutters & Downpipes',
    comment: 'Reliable, certified, and friendly team. Peter walked us through Colorbond profile options for our gutters and downpipes. The installation was seamless, clean, and completed in just two days. Our stormwater drainage flows perfectly now.',
    verified: true,
  },
  {
    id: 'gr-5',
    ...
    project: 'Concrete Tile Roof Restoration & Painting',
    comment: 'Our 30-year-old tile roof looked weathered and faded. Assist pressure cleaned, repaired broken tiles, and applied a high-durability heat reflective roof coating. The house looks brand new! Great communication from Boxy throughout the entire job.',
    verified: true,
  },
  {
    id: 'gr-6',
    name: 'Andrew & Fiona Miller',
    suburb: 'Camberwell, VIC',
    avatarBg: '#0284c7',
    avatarInitials: 'AM',
    rating: 5,
    timeAgo: '2 months ago',
    project: 'Full Roof Strip & Sarking Installation',
    comment: 'From our initial consultation with Peter to the final sign-off, the communication was top notch. They removed our old tiles, installed heavy duty AS/NZS sarking, and laid modern corrugated iron. The 10-year warranty gives us complete peace of mind.',
    verified: true,
  },
  {
    id: 'gr-7',
    ...
    project: 'Skylight Installation & Roof Flashing',
    comment: 'Installed two Velux skylights and re-flashed our chimney. Zero leaks through recent Melbourne downpours. Peter and his crew respect your home, turn up on time, and deliver true craftsmanship. Highly recommended.',
    verified: true,
  },
  {
    id: 'gr-8',
    ...
    rating: 5,
    timeAgo: '3 months ago',
    project: 'Storm Damage Repair & Pergola Roofing',
    comment: 'A fallen tree branch punctured our garage and pergola roofing. Assist came to the rescue with emergency tarping and replaced the corrugated sheets the next morning. Efficient, licensed, and reasonably priced. Excellent team!',
    verified: true,
  },
];
