...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-white pt-24 pb-8 px-6 flex flex-col md:hidden overflow-y-auto">
          <nav className="flex flex-col gap-6 mt-8">
            ...
            <button 
              ...
              className="bg-accent-500 text-white px-6 py-4 rounded-xl font-bold text-lg mt-4 text-center"
            >
              Get a Quote
            </button>
          </nav>
